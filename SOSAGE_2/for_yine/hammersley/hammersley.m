...
%  Parameters:
%
%    Input, dummy, is a dummy argument that I will have to live with
%    until I can figure out a better way.  I refuse to allow a
%    function without arguments to be declared without parentheses;
%    that is DEMANDING trouble!
%
%    Output, real R(1:DIM_NUM), the SEED-th element of the Hammersley sequence
%    for base BASE.
%
  dim_num = hammersley_dim_num_get ( 'DUMMY' );
  step = hammersley_step_get ( 'DUMMY' );
  seed = hammersley_seed_get ( 'DUMMY' );
  leap = hammersley_leap_get ( 'DUMMY' );
  base = hammersley_base_get ( 'DUMMY' );
